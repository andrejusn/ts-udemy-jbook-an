...
export const typecheckPlugin = (inputCode: string) => {
  return {
    ...
    setup(build: esbuild.PluginBuild) {
      ...
      const result: CompileResult = compile(tsValid);
      console.log(result);

      // // OUTPUT:
      // // > error: Cannot find module 'typescript' 0aa7af02-507f-4476-a967-dcc028250455:8:24
      // // 1 error 0aa7af02-507f-4476-a967-dcc028250455:8:24
